...
export default function VideoWithhooks(props) {
  ...
  useEffect(()=> {
  console.log('cn: ',props.navigation.state.params.chennelId )
    // this.state = {
    ...
    //     //  channelId:' this.props.navigation.state.params.channelId',             //  this.props.state.params.channelId,        //Channel Name for the current session
